...
export default async function KoreanPage(props: { params: Promise<{ slug?: string[] }> }) {
  const page = source.getPage((await props.params).slug, "ko");
  if (!page) notFound();
...
export function generateStaticParams() {
  return source.generateParams("slug", "locale").filter((params) => params.locale === "ko");
}
