...
The React component does not expose `HeatmapState`. Its host owns the visible root, breadcrumbs, and selected key; pass a new immutable `data` reference when values change. See [React Integration](/docs/react).
