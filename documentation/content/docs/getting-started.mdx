...
<Callout type="info">Use Kotlin/Compose `2.0.2` for core, Compose, and optional Coil. This version adds group-wide hover and press feedback on pointer platforms.</Callout>
