...
if (!result) throw new Error("Missing smoke-test result element.");
...
try {
  ...
  result.textContent = "PASS: Kotlin/JS core loaded and both APIs returned expected browser results.";
} catch (error) {
